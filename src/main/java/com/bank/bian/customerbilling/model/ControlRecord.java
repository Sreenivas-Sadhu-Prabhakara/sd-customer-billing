package com.bank.bian.customerbilling.model;
...
/**
 * The BIAN control record for this service domain: "Customer Bill Procedure".
 *
 ...
 * to its asset type (Customer Bill). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Customer Bill Procedure";
